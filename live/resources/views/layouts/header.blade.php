...
<body class="not-old-vczh w-1000"><iframe src="//www.huya.com/act/proxy/storage.html" style="display: none;"></iframe>
    ...
    <div class="duya-header-wrap clearfix">
        <div class="duya-header-bd clearfix">
            ...
            <div class="duya-header-nav">
                ...
                <span class="hy-nav-link duya-header-on"><a href="http://www.huya.com/l" class="hy-nav-title hiido_stat clickstat" hiido_code="10004221" eid="click/navi/zhibo" eid_desc="点击/导航/直播">直播</a></span>
            ...
            <div class="duya-header-right" id="J_duyaHeaderRight"><div class="duya-header-control clearfix">
    ...
    <div class="hy-nav-right">
        ...
        <div class="nav-expand-list nav-expand-download">
            ...
            <div class="download-nav">
                ...
                <a target="_blank" href="http://maimai.huya.com/"><i class="hy-nav-mm-icon"></i><span>语音开黑</span></a>
...
var UDB_SDK_SWTICH = true;
    ...
    <!-- E 通用头部 -->
    <div class="js-responded-list narrow" style="height: 685px;">
        <div class="mod-list">
            <div class="box">
                                <div class="list-notice">
    <a href="" target="_blank" id="ggcomment" data-area="9" class="clickstat third-clickstat" eid="click/push/banner/alllive" eid_desc="点击/推荐/列表页顶部推荐/全部直播"></a>
</div>
                <!-- 标签快速选择 -->
    ...
    <dl id="js-filter-list" class="clearfix">
        <dd class="clickstat active" data-id="0" data-type="tagAll" eid="click/list/all/all" eid_desc="点击/标签/全部直播/全部">全部</dd>
            ...
            视频美女        </dd>
                        <dd class="clickstat" data-id="608" data-type="tmpId" eid="click/list/all/608" eid_desc="点击/标签/全部直播/蓝光">
            蓝光        </dd>
                            </dl>
</div>
                </div>
